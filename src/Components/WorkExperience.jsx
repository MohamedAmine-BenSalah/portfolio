    ...
    <div className="main-experience">
      <div className="work-ex">
        ...
        <div className="ex">
          <h3>Pizzaiolo</h3>
          <p>
            From May 2020 to August 2022 <span>PizzaShop Sousse</span>
          </p>
        </div>
        <div className="ex">
          <h3>Semi Chef</h3>
          <p>
            From May 2020 to April 2021 <span>Catalina Hammamet</span>
          </p>
        </div>
        <div className="ex">
          <h3>Party Leader</h3>
          <p>
            From May 2020 to April 2021 <span> Room Food Hammamet</span>
          </p>
        </div>
        <div className="ex">
          <h3>Pizzaiolo</h3>
          <p>
            ...
            <span>Resto Bar L'Opera Hammamet</span>
          </p>
        </div>
        <div className="ex">
          <h3>Pizzaiolo</h3>
          <p>
            From September 2018 to May 2020 <span>NessCute Hammamet</span>
          </p>
        </div>
      </div>
